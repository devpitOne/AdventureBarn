...
using AdventureBarn.DataAccess.Repositories;
using System;
using Unity;
...
namespace AdventureBarn.WorkSite
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IGenericRepository<Shelf>, GenericRepository<Shelf>>();
            container.RegisterType<IGenericRepository<Stock>, GenericRepository<Stock>>();
